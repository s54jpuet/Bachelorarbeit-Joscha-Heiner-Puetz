...
# 1. Ableitung der sphärischen Bessel-Funktion 
def djl(l, x):
    if l==0:
...
# 1. Ableitung der sphärischen Neumann-Funktion
def dyl(l, x):
    if l==0:
...
# 2. Ableitung der sphärischen Bessel-Funktion 
def d2jl(l, x):
    if l == 0:
...
# 2. Ableitung der sphärischen Neumann-Funktion
def d2yl(l, x):
    if l == 0:
...
# 1. Ableitung der sphärischen Hankel-Funktion
def dhl(l, x):
    return djl(l, x) + 1.j* dyl(l,x)

# 2. Ableitung der sphärischen Hankel-Funktion
def d2hl(l, x):
