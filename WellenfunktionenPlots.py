...
def rs_plot_wavefunction(l_list, v0, x_max_intervall):
   ...
   plt.grid(True)
   plt.tight_layout()  # Vor der Legende, für bessere Anpassung
   plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))

   # Zielordner und eindeutiger Dateiname
   out_dir = os.path.join("Plots_Wellenfunktionen")
   os.makedirs(out_dir, exist_ok=True)
   # sichere Formatierung von v0 (z.B. wissenschaftlich, Punkt durch _ für Filename)
