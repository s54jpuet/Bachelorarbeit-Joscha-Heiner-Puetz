...
def check_correspondence(l):
    ...
    # auf gemeinsame Länge bringen, falls nicht schon der Fall
    n = min(v0_rs.size, v0_bs.size)
    v0_rs, s_rs = v0_rs[:n], s_rs[:n]
    v0_bs, s_bs = v0_bs[:n], s_bs[:n]

    # Differenz und kombinierter Fehler
    delta = v0_bs - v0_rs
    sigma_delta = s_rs + s_bs 

    # prüfen Differenz in Fehlerintervall
    ...
    # Resultate in Tabellen speichern
